...
.. py:class:: Data4D(v, mat, tris=None, img_idx=None, face_idx=None, video_metadata=None, cam_mat=None, space='world', device=DEVICE)
   ...
   .. py:method:: render_video(f_out, renderer='pytorch3d', shading='flat', video=None, alpha=1, **kwargs)
      ...
      :type f_out: str
      :param renderer: Either 'pyrender' or 'pytorch3d' (if installed)
      :type renderer: str
      ...
      :type alpha: float
      :param \*\*kwargs: Keyword arguments supplied to renderer initialization
