:py:mod:`medusa.render.pytorch3d`
=================================

.. py:module:: medusa.render.pytorch3d
...
.. py:class:: PytorchRenderer(viewport, cam_mat=None, cam_type='orthographic', shading='flat', lights='sh', device=DEVICE)
   ...
   :type cam_type: str
   :param shading: Type of shading ('flat', 'smooth', or 'wireframe')
   :type shading: str
