...
``face_alignment`` package by `Adrian Bulat <https://www.adrianbulat.com/face-
alignment>`_ [1]_. or the ``insightface`` package [2]_. Note that the
``insightface`` package is not installed by default. To install this package,
