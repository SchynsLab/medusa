...
:py:mod:`medusa.core._4D`
=========================

.. py:module:: medusa.core._4D
...
.. py:class:: Base4D(v, f, mat=None, cam_mat=None, frame_t=None, events=None, sf=None, img_size=(512, 512), recon_model=None, space='world', path=None, loglevel='INFO')
...
.. py:class:: Fan4D(*args, **kwargs)
   ...
   .. py:method:: render_video(f_out, video=None, scaling=None, n_frames=None)
